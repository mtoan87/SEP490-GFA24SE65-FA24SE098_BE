...
namespace ChildrenVillageSOS_SERVICE.Interface
{
    public interface IChildService
    {
        ...
        Task<IEnumerable<ChildResponseDTO>> GetChildrenBadStatusByUserId(string userAccountId);
        ...
        Task<IEnumerable<ChildDonatedDTO>> GetDonationsForChildAsync(string childId);
    }
}
